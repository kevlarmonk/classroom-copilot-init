...
class ColoredFormatter(logging.Formatter):
    ...
    COLORS = {
        ...
        logging.DEBUG: LogColors.LIGHTGREEN, # Level 10
...
def get_logger(name=None, log_level=None, log_file=None):
    """
    ...
    if not logger.handlers:
        ...
        log_file_path = os.path.join(log_path, f"{log_file}_{datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.log")
